...
class FirebaseFirestoreProvider with ChangeNotifier {
  ...
  Future<void> addTransaction(Map<String, dynamic> transaction) async {
    await _firestore.collection(transactionsCollection).add(transaction);
  }
  ...
  Future<void> addGoal(Map<String, dynamic> goal) async {
    await _firestore.collection(goalsCollection).add(goal);
  }
  ...
  Future<void> addBudget(Map<String, dynamic> budget) async {
    await _firestore.collection(budgetsCollection).add(budget);
  }
  ...
  Future<void> addNotification(Map<String, dynamic> notification) async {
    await _firestore.collection(notificationsCollection).add(notification);
  }
